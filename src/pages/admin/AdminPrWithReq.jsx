...
export default function AdminPrWithReq() {
  ...
  const filteredWithdrawals = useMemo(() => {
    ...
    return allwithdrawal.filter((item) => {
      const matchesType = item?.type === "principle";
  ...
  const getStatusIcon = (status) => {
    switch (status?.toLowerCase()) {
      ...
      case "inprogress": return <Timer className="w-3 h-3" />;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-blue-950/20 to-[#0a0a0a] p-4 md:p-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-white via-amber-100 to-orange-300 bg-clip-text text-transparent">
                Principle Withdrawal Requests
              </h1>
              <p className="text-slate-400 text-sm mt-1">
                Manage and process principle withdrawal requests
              </p>
            </div>
          </div>
          <button
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 animate-in fade-in-up duration-500 delay-100">
          <div className="relative overflow-hidden rounded-2xl bg-white/5 backdrop-blur-md border border-white/10 p-5 hover:scale-105 transition-all duration-300 group">
            ...
            <div className="relative">
              ...
              <p className="text-xs text-slate-500 mt-1">Principle withdrawal requests</p>
            </div>
          ...
          <div className="relative overflow-hidden rounded-2xl bg-white/5 backdrop-blur-md border border-white/10 p-5 hover:scale-105 transition-all duration-300 group">
            ...
            <div className="relative">
              ...
              <p className="text-xs text-slate-500 mt-1">Total requested amount</p>
            </div>
          ...
          <div className="p-5 border-b border-white/10">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-white font-semibold text-lg">Principle Withdrawal Requests</h2>
          ...
          <div className="overflow-x-auto custom-scroll">
            {loading ? (
              ...
              <div className="text-center py-16">
                ...
                <p className="text-slate-400 text-lg">No principle withdrawal requests found</p>
                    ...
                    <tr key={item?.id || index} className="hover:bg-white/5 transition-all duration-300 group animate-in fade-in-up" style={{ animationDelay: `${index * 30}ms` }}>
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center justify-center gap-3">
                          <Link to={`/admin/check/profile/${item?.user_id}`} className="text-emerald-400 hover:text-emerald-300 transition-colors">
      ...
      {/* ✅ Sirf ek WagmiCryptoComponent — Pay button click pe modal */}
      {selectedWithdrawal && (
          ...
          <div className="bg-[#1e1e1e] rounded-xl shadow-lg w-full max-w-md p-6 relative">
            ...
            <WagmiCryptoComponent
              ...
              onTransactionComplete={() => {
                // ✅ Transaction complete hone pe status update
                dispatch(
                  updatePrincipleWithdrawal({
                    id: selectedWithdrawal?.id,
                    status: "complete",
                    amount: selectedWithdrawal?.amount + selectedWithdrawal?.deduction,
